...
%% load file
load("D:\Github\LHD程序20250320\data_analyze\oddball_ERP_50.mat")
%% only use it
% FronElec = [8:12 17:21];
% zoom = FronEle
...
child_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,child_cond,zoom,:),1),2),3));
pregnant_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,pregnant_cond,zoom,:),1),2),3));
civilian_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,civilian_cond,zoom,:),1),2),3));
drug_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,drug_cond,zoom,:),1),2),3));
criminal_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,criminal_cond,zoom,:),1),2),3));
none_info = squeeze(nanmean(nanmean(nanmean(subjs_oddball_ERP(subjectnum,none_cond,zoom,:),1),2),3));
...
if any(ismember(line_type,1))
        ...
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,child_cond,zoom,display_time_start:display_time_end),3));
...
if any(ismember(line_type,2))
        ...
        hold on
        current_layer = current_layer + 1;
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,pregnant_cond,zoom,display_time_start:display_time_end),3));
        y_s(current_layer,:,:) = reshape(temdata,1,50,[]);
end
if any(ismember(line_type,3))
        ...
        hold on
        current_layer = current_layer + 1;
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,civilian_cond,zoom,display_time_start:display_time_end),3));
        y_s(current_layer,:,:) = reshape(temdata,1,50,[]);
end
if any(ismember(line_type,4))
        ...
        hold on
        current_layer = current_layer + 1;
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,drug_cond,zoom,display_time_start:display_time_end),3));
        y_s(current_layer,:,:) = reshape(temdata,1,50,[]);
end
if any(ismember(line_type,5))
        ...
        hold on
        current_layer = current_layer + 1;
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,criminal_cond,zoom,display_time_start:display_time_end),3));
        y_s(current_layer,:,:) = reshape(temdata,1,50,[]);
end
if any(ismember(line_type,6))
        ...
        hold on 
        current_layer = current_layer + 1;
        temdata = squeeze(nanmean(subjs_oddball_ERP(subjectnum,none_cond,zoom,display_time_start:display_time_end),3));
        y_s(current_layer,:,:) = reshape(temdata,1,50,[]);
end
